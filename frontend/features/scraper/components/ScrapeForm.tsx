...
export default function ScrapeForm() {
  ...
  const { loadScrapeJobs, loadScrapeStats } = useScraperStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult(job);
      // Reload stats and jobs in the store
      loadScrapeJobs(1, 20);
      loadScrapeStats();
    } catch (err: unknown) {
      setError(
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex items-center gap-2 px-4 py-3 h-auto rounded-xl cursor-pointer whitespace-nowrap"
                >
